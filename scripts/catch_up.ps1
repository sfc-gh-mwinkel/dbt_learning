...
function Setup-Lesson {
    ...
    switch ($LessonNum) {
        ...
        2 {
            ...
            Write-Host "3. Create stg_customers.yml and stg_orders.yml (follow lesson instructions)"
        }
        3 {
            ...
            Copy-IfMissing "assets\yml_templates\sources.yml" "models\staging\sources.yml" "sources.yml"
            Copy-IfMissing "assets\yml_templates\staging\stg_customers.yml" "models\staging\stg_customers.yml" "stg_customers.yml"
            Copy-IfMissing "assets\yml_templates\staging\stg_orders.yml" "models\staging\stg_orders.yml" "stg_orders.yml"
            Copy-IfMissing "assets\yml_templates\staging\stg_products.yml" "models\staging\stg_products.yml" "stg_products.yml"
            Copy-IfMissing "assets\yml_templates\staging\stg_order_items.yml" "models\staging\stg_order_items.yml" "stg_order_items.yml"
            Copy-IfMissing "assets\yml_templates\staging\stg_payments.yml" "models\staging\stg_payments.yml" "stg_payments.yml"
            Write-Host ""
            Write-Host "Next steps:"
            Write-Host "1. Run: dbt seed"
            Write-Host "2. Run: dbt run --select staging"
